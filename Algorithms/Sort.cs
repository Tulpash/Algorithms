namespace Algorithms
{
    public static class Sort
    {
        ...
        public static void InsertionSort<T>(IList<T> arr, int start, int end) where T : IComparable<T>
        {
            ValidArray(arr, start, end);
            if (start == end) return;
        ...
        {
            InsertionSort(arr, 0, arr.Count - 1);
        }
        #endregion
        ...
        private static void SelectionSort<T>(IList<T> arr, int start, int end) where T : IComparable<T>
        {
            ValidArray(arr, start, end);
            if (start == end) return;
        ...
        private static void SelectionSort<T>(IList<T> arr) where T : IComparable<T>
        {
            SelectionSort(arr, 0, arr.Count - 1);
        }
        #endregion
    }
}
